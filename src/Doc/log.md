...
- 更新版本至 `1.4.0 alpha`
- 修复主界面按钮中文翻译缺失问题
  - 补充 `ModelBox` 按钮的中英文翻译
  - 修改 `ModelBox` 和 `TextureEditor` 按钮使用 LANG 字典
  - 完善 `retranslate_ui` 函数中的语言切换逻辑
- 更新 `README.md` 文档
- 更新文档目录 `src/Doc/ToolsModule`
  - 新增 `ModelBox.md` 文档
  - 新增 `TextureEditor.md` 文档
- 更新 `QuickRename.md` 文档
  - 添加自定义配置说明章节
  - 说明如何自定义前后缀、分组和显示层按钮
